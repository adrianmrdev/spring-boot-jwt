...
public class FacturaController {
	...
	public String crear(@PathVariable(value = "cliente_id") Long cliente_id, Map<String, Object> model,
	...
	public String guardar(@Valid Factura factura, BindingResult result, Model model,
		...
		for (int i = 0; i < itemId.length; i++) {
			...
			ItemFactura lineaFactura = new ItemFactura();
			lineaFactura.setCantidad(cantidad[i]);
			lineaFactura.setProducto(producto);
			factura.addItemFactura(lineaFactura);
		...
		flash.addFlashAttribute("success", "La factura se ha guardado correctamente");
	...
	public String eliminar(@PathVariable("id") Long id, RedirectAttributes flash) {
		...
		flash.addFlashAttribute("error", "La factura no existe, no se puede eliminar");
