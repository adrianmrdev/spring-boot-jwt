...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		tabla3.addCell(mensajes.getMessage("text.cliente.factura.producto"));
		tabla3.addCell(mensajes.getMessage("text.cliente.factura.precio"));
		tabla3.addCell(mensajes.getMessage("text.cliente.factura.cantidad"));
		tabla3.addCell(mensajes.getMessage("text.cliente.factura.total"));
		...
		cell = new PdfPCell(new Phrase(mensajes.getMessage("text.cliente.factura.total") + ": "));
		cell.setColspan(3);
